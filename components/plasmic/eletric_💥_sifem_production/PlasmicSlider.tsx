...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 9cNYda3sepLA/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: SZ3Yo7GwrExQ/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gt7GS)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__redOl)}>
        <div
