...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 6xrDR60XpzMB/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___6Rdxx)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___3LBU)}>
            <div
              className={classNames(
                projectcss.all,
