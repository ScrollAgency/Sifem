...
import sty from "./PlasmicCheckboxWrapper.module.css"; // plasmic-import: TrtFcuhzOzKv/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__b5Jhj, {
                [sty.checkboxhasMedia__b5Jhj9AAav]: hasVariant(
                  $state,
                  "hasMedia",
                  "hasMedia"
                )
