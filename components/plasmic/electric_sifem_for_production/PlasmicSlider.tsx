...
import SliderThumb from "../../SliderThumb"; // plasmic-import: vCE-rDIpvw_E/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: JMgNFe6x6TFy/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__faEfY)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__n8H2J)}>
        <div
