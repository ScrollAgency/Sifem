...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: Jm6Gnqw3Xb6Y/css

import Checkbox2SvgIcon from "./icons/PlasmicIcon__Checkbox2Svg"; // plasmic-import: RBH4XqQLQy2d/icon
import Checkbox1SvgIcon from "./icons/PlasmicIcon__Checkbox1Svg"; // plasmic-import: _jTFsEbW1lhT/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: ZwM0lflfpFgc/icon
import Checkbox3SvgIcon from "./icons/PlasmicIcon__Checkbox3Svg"; // plasmic-import: yUuzALrMucwn/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: rAW3GnrJKdk2/icon
          ...
          >
            ...
            >
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg__ifTDc, {
                  [sty.svg___focusVisibleWithin__ifTDcdvwd8]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked__ifTDcPpObQ]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled__ifTDcUnVU]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate__ifTDcjd5Ig]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel__ifTDcJy2WI]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
              ...
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg__bziFv, {
                  [sty.svg___focusVisibleWithin__bziFVdvwd8]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked__bziFvPpObQ]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled__bziFvunVU]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate__bziFVjd5Ig]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel__bziFvjy2WI]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
            ...
            {(hasVariant($state, "noLabel", "noLabel") ? false : true) ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__zWlm)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
...
function useBehavior<P extends pp.CheckboxProps>(
  ...
  if (!("children" in props)) {
    props = {
      ...props,
      children: (
        <div className={classNames(projectcss.all, sty.freeBox__zWlm)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
