...
import Label from "../../Label"; // plasmic-import: ntE7az8SojAE/component
import TextInput from "../../TextInput"; // plasmic-import: tCsfCtJVvahK/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: bu_uuy5nmryI/component
import Description from "../../Description"; // plasmic-import: Gawfpx0EAMXy/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: Gb44VeaKIga4/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___4PBsM, {
          [sty.freeBoxiconEnd___4PBsMJsQce]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___4PBsMMn61]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___4PBsMIdgyR]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4PatQ, {
            [sty.freeBoxiconStart___4PatQMn61]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___4PatQIdgyR]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8P9Jx)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___6DIj, {
            [sty.freeBoxiconEnd___6DIjJsQce]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___6DIjMn61]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zb3A8)}
                role={"img"}
              />
            ),
