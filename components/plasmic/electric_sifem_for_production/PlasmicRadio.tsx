...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: CNvCpIu9p4BU/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___5YadD)}>
        <div className={classNames(projectcss.all, sty.freeBox__wl0Z7)} />
      </div>
      {renderPlasmicSlot({
