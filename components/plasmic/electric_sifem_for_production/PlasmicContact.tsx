...
import sty from "./PlasmicContact.module.css"; // plasmic-import: tkhdnta3HWTg/css
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__qKj56,
                    {
                      [sty.textglobal_locale_en__qKj56K2ON]: hasVariant(
                        globalVariants,
                        "locale",
                        "en"
                      )
                ...
                >
                  {hasVariant(globalVariants, "locale", "en") ? (
                    <React.Fragment>
                      <React.Fragment>
                        {
                          "Do you have a question about the dPEI score?\nHave you identified an issue with the app?\nSend us an email:\r\n\r\n"
                        }
                      </React.Fragment>
                      {
                        <PlasmicLink__
                          ...
                          className={classNames(
                            ...
                            sty.link,
                            {
                              [sty.linkglobal_locale_en]: hasVariant(
                                globalVariants,
                                "locale",
                                "en"
                              )
...
const PlasmicDescendants = {
  ...
  button: ["button"],
  input: ["input", "adh", "title", "password", "content", "link"],
  adh: ["adh", "title", "password", "content", "link"],
