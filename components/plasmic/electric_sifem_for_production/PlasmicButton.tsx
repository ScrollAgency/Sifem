...
import sty from "./PlasmicButton.module.css"; // plasmic-import: EQB74Mlk8maB/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: kIzBP5ddCB9d/icon
import PlusIcon from "./icons/PlasmicIcon__Plus"; // plasmic-import: H7Sr5IxbXDmk/icon
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_tabCurrent]: hasVariant($state, "color", "tabCurrent"),
          [sty.rootcolor_tab]: hasVariant($state, "color", "tab"),
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__xyLwb)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainershape_round]: hasVariant(
            $state,
            "shape",
            "round"
          ),
      ...
      >
        {(hasVariant($state, "shape", "round") ? false : true)
          ? renderPlasmicSlot({
              ...
              className: classNames(sty.slotTargetChildren, {
                ...
                [sty.slotTargetChildrencolor_tabCurrent]: hasVariant(
                  $state,
                  "color",
                  "tabCurrent"
                ),
                [sty.slotTargetChildrencolor_tab]: hasVariant(
                  $state,
                  "color",
                  "tab"
                ),
        ...
        <PlusIcon
          ...
          className={classNames(projectcss.all, sty.svg, {
            [sty.svgshape_round]: hasVariant($state, "shape", "round")
          })}
          role={"img"}
        />
      </div>
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__lIr0G)}
                role={"img"}
              />
            ),
