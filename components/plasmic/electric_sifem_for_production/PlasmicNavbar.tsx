...
import Select2 from "../../Select2"; // plasmic-import: mgeI7HP7VE7B/component
import { LocaleToggleWrapper } from "@plasmic-library/jean/LocaleToggleWrapper/LocaleToggleWrapper"; // plasmic-import: wOAc_ISk_a82/codeComponent
...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: BwloLoutGE6h/css

import IconsaxLinearHambergermenuIcon from "./icons/PlasmicIcon__IconsaxLinearHambergermenu"; // plasmic-import: mrDKc7R3WlVx/icon
...
import X2Icon from "./icons/PlasmicIcon__X2"; // plasmic-import: AzHY7YrhjYUl/icon
...
function PlasmicNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__veLt2)}>
        <PlasmicLink__
        ...
        >
          <IconsaxLinearHambergermenuIcon
            className={classNames(projectcss.all, sty.svg__tzLSp)}
            role={"img"}
          />
        </PlasmicLink__>
        <div
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__jYTbr)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/electric_sifem_for_production/images/logoDPeiPocketPng.png",
              fullWidth: 811,
              fullHeight: 86,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ggM1Y)}
        >
          <Select2
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                children={null}
                className={classNames("__wab_instance", sty.button__jy1BG)}
                shape={"round"}
              />
            ),
      ...
      {(() => {
        ...
        >
          ...
          >
            <X2Icon
              className={classNames(projectcss.all, sty.svg__jAjCp)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__a9Gsa, {
                  [sty.imgglobal_locale_en__a9Gsak2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__i0RXg,
                {
                  [sty.linkglobal_locale_en__i0RXgk2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  ),
                  [sty.linkglobal_locale_fr__i0RXglyq0K]: hasVariant(
                    globalVariants,
                    "locale",
                    "fr"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__h4W7I,
                {
                  [sty.linkglobal_locale_en__h4W7IK2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link___2Nwr8,
                {
                  [sty.linkglobal_locale_en___2Nwr8K2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__t1LEk,
                {
                  [sty.linkglobal_locale_en__t1LEkk2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__b1ZG4,
                {
                  [sty.linkglobal_locale_en__b1ZG4K2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__fueE1,
                {
                  [sty.linkglobal_locale_en__fueE1K2ON]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
