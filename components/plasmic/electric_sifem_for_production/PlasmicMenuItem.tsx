...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 41kncarkuUQZ/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cozpC)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__eQ3H)}>
            <div
              className={classNames(
                projectcss.all,
