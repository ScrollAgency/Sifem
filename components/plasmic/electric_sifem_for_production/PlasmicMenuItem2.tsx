...
import sty from "./PlasmicMenuItem2.module.css"; // plasmic-import: Ly_RfSfi2QCw/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__sfwqK)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__hcABp)}>
            <div
              className={classNames(
                projectcss.all,
