...
import MenuPopover from "../../MenuPopover"; // plasmic-import: TSxb47r3fPT6/component
import MenuItem from "../../MenuItem"; // plasmic-import: 41kncarkuUQZ/component
import MenuSection from "../../MenuSection"; // plasmic-import: -S8gliWzwnEf/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: PqNGeES_8SPV/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__catCx)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
