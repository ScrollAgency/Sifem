...
import sty from "./PlasmicCheckboxWrapper.module.css"; // plasmic-import: gRRqjsh033Ca/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__z4V8E, {
                [sty.checkboxhasMedia__z4V8EyOrv]: hasVariant(
                  $state,
                  "hasMedia",
                  "hasMedia"
                )
