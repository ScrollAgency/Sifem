...
import sty from "./PlasmicModal.module.css"; // plasmic-import: KnD_ioEvAONZ/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_aBzTJStPvPNH"]]: true })}
        ...
        >
          ...
          >
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__rgmbl)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__oh0Bw)}>
                  <Button2
                    color={"muted"}
                    label={
                      <div
