...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 3BWKCht5CjdE/css

import Checkbox2SvgIcon from "./icons/PlasmicIcon__Checkbox2Svg"; // plasmic-import: CE1mnQZvR7-b/icon
import Checkbox1SvgIcon from "./icons/PlasmicIcon__Checkbox1Svg"; // plasmic-import: 9siRqnPDOokI/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: GhD_30mCOIns/icon
import Checkbox3SvgIcon from "./icons/PlasmicIcon__Checkbox3Svg"; // plasmic-import: 9WhbOGrGxx7R/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: YKcRQoTFv0bc/icon
          ...
          >
            ...
            >
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg__au3X1, {
                  [sty.svg___focusVisibleWithin__au3X10Pevv]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked__au3X1DlbRy]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled__au3X1Wn6TT]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate__au3X1CYx7Q]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel__au3X1Negth]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
              ...
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg__aVm5G, {
                  [sty.svg___focusVisibleWithin__aVm5G0Pevv]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked__aVm5GdlbRy]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled__aVm5Gwn6TT]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate__aVm5GcYx7Q]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel__aVm5GNegth]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
            ...
            {(hasVariant($state, "noLabel", "noLabel") ? false : true) ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__gvmzk)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
...
function useBehavior<P extends pp.CheckboxProps>(
  ...
  if (!("children" in props)) {
    props = {
      ...props,
      children: (
        <div className={classNames(projectcss.all, sty.freeBox__gvmzk)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
