...
import Label from "../../Label"; // plasmic-import: 9WXu9Q78ne5P/component
import TextInput from "../../TextInput"; // plasmic-import: 3zxBamEcgzkd/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: XgrlS1o7O9V4/component
import Description from "../../Description"; // plasmic-import: FK1bXJQItRgc/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: Fm6BGUYjwAzT/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___5JCt1, {
          [sty.freeBoxiconEnd___5JCt1VSx1R]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___5JCt1B8Dcu]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___5JCt1QMfOf]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__noaV9, {
            [sty.freeBoxiconStart__noaV9B8Dcu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__noaV9QMfOf]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lfgNb)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__gYwqn, {
            [sty.freeBoxiconEnd__gYwqnVSx1R]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__gYwqnb8Dcu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___61AqA)}
                role={"img"}
              />
            ),
