...
import sty from "./PlasmicContact.module.css"; // plasmic-import: yKpW6cVVed2G/css
...
export type PlasmicContact__ArgsType = { isChecked2?: boolean };
type ArgPropType = keyof PlasmicContact__ArgsType;
export const PlasmicContact__ArgProps = new Array<ArgPropType>("isChecked2");
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__cma9,
                    {
                      [sty.textglobal_locale_en__cma9E9AXj]: hasVariant(
                        globalVariants,
                        "locale",
                        "en"
                      )
                ...
                >
                  {hasVariant(globalVariants, "locale", "en") ? (
                    <React.Fragment>
                      <React.Fragment>
                        {
                          "Have a question about the dPEI score?\r\n\rFound an issue on the application?\r\n\rSend us an email:\r\n\r\n"
                        }
                      </React.Fragment>
                      {
                        <PlasmicLink__
                          className={classNames(
                            ...
                            sty.link__twhuK,
                            {
                              [sty.linkglobal_locale_en__twhuKe9AXj]:
                                hasVariant(globalVariants, "locale", "en")
                            }
                          )}
                          component={Link}
                          href={"mailto:contact@dpei-score.org"}
                          platform={"nextjs"}
                        >
                          {hasVariant(globalVariants, "locale", "en")
                            ? "contact@dpei-score.org"
                            : hasVariant(globalVariants, "screen", "mobileOnly")
                            ? "contact@dpei-score.org"
                            : "contact@dpei-score.org"}
                        </PlasmicLink__>
                    ...
                    <React.Fragment>
                      <React.Fragment>
                        {
                          "Vous avez une question sur le score dPEI ?\r\nVous avez identifi\u00e9 un probl\u00e8me sur l\u2019application ?\r\nEnvoyez-nous un e-mail :\r\n\r\n"
                        }
                      </React.Fragment>
                      {
                        <PlasmicLink__
...
const PlasmicDescendants = {
  ...
  button: ["button"],
  input: ["input", "adh", "title", "password", "content"],
  adh: ["adh", "title", "password", "content"],
