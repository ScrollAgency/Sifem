...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: LhnnhgHcYRyf/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wSm2R)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__kqMvn)}>
            <div
              className={classNames(
                projectcss.all,
