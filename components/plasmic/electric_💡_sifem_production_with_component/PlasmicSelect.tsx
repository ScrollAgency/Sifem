...
import MenuPopover from "../../MenuPopover"; // plasmic-import: Gth-Crs4PVCU/component
import MenuItem from "../../MenuItem"; // plasmic-import: LhnnhgHcYRyf/component
import MenuSection from "../../MenuSection"; // plasmic-import: eMWlYSWPuwcj/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: eQ2_PFQXRxkm/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__w4Ga)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
