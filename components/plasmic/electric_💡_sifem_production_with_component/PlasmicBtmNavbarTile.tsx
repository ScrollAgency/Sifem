...
import sty from "./PlasmicBtmNavbarTile.module.css"; // plasmic-import: RrYoKYHMUcDL/css
              ...
              defaultContents: (
                <React.Fragment>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___8J8Qy)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__zkXvS)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__g25O)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__aVnyr)}
                    />
                  </Stack__>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__neGaf)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__rnl4T)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__cjXaE)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__prbCd)}
                    />
                  </Stack__>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__tJ4Qn)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__yDgK)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__i9SwD)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__ciBc8)}
                    />
                  </Stack__>
                </React.Fragment>
              ),
