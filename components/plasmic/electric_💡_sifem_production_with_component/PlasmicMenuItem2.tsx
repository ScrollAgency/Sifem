...
import sty from "./PlasmicMenuItem2.module.css"; // plasmic-import: ew7FJhN9rVji/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__uVdIk)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wKh3V)}>
            <div
              className={classNames(
                projectcss.all,
