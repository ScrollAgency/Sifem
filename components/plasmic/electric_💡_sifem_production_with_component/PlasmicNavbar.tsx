...
import { LocaleToggleWrapper } from "@plasmic-library/jean/LocaleToggleWrapper/LocaleToggleWrapper"; // plasmic-import: fr6_NDsgMK4l/codeComponent
...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: iTXTkoFT2sZK/css

import IconsaxLinearHambergermenuIcon from "./icons/PlasmicIcon__IconsaxLinearHambergermenu"; // plasmic-import: YSzPmbROOyyL/icon
...
import X2Icon from "./icons/PlasmicIcon__X2"; // plasmic-import: 6W8cQl24eWz4/icon
...
function PlasmicNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__vJjFs)}>
        <PlasmicLink__
        ...
        >
          <IconsaxLinearHambergermenuIcon
            className={classNames(projectcss.all, sty.svg___4OcwS)}
            role={"img"}
          />
        </PlasmicLink__>
        <div
        ...
        >
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__clUld)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/electric_💡_sifem_production_with_component/images/logoDPeiPocketPng.png",
              fullWidth: 811,
              fullHeight: 86,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__aIiqW)}
        >
          <Select2
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                children={null}
                className={classNames("__wab_instance", sty.button___5Y8Pj)}
                shape={"round"}
              />
            ),
      ...
      {(() => {
        ...
        >
          ...
          >
            <X2Icon
              className={classNames(projectcss.all, sty.svg__eyvUl)}
              onClick={async event => {
                const $steps = {};
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__jyTe6, {
                  [sty.imgglobal_locale_en__jyTe6E9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__ck1Wl,
                {
                  [sty.linkglobal_locale_en__ck1WLe9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  ),
                  [sty.linkglobal_locale_fr__ck1WLlltIv]: hasVariant(
                    globalVariants,
                    "locale",
                    "fr"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__lKcUw,
                {
                  [sty.linkglobal_locale_en__lKcUwe9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__fY1N,
                {
                  [sty.linkglobal_locale_en__fY1Ne9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__yASw,
                {
                  [sty.linkglobal_locale_en__yASwe9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link___41UIz,
                {
                  [sty.linkglobal_locale_en___41UIZe9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
          ...
          >
            <PlasmicLink__
              className={classNames(
                ...
                sty.link__w2GsX,
                {
                  [sty.linkglobal_locale_en__w2GsXe9AXj]: hasVariant(
                    globalVariants,
                    "locale",
                    "en"
                  )
