...
import SliderThumb from "../../SliderThumb"; // plasmic-import: sgGScC_iqn9M/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: wcgNq1ruDYrC/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___3XpwC)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__btqZe)}>
        <div
