...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: JtsdCnptcP2e/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__nrr7A)}>
        <div className={classNames(projectcss.all, sty.freeBox___0NpW)} />
      </div>
      {renderPlasmicSlot({
