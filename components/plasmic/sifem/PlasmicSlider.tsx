...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 3l68_DaDp5e3/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: -iXcvguCMr4e/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__jNcrq)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__q4P0T)}>
        <div
