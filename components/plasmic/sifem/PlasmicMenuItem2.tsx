...
import sty from "./PlasmicMenuItem2.module.css"; // plasmic-import: UZ680D6oFu4N/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hlfyI)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__yWbJc)}>
            <div
              className={classNames(
                projectcss.all,
