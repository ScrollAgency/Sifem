...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 2R9qvZhzOfzS/css

import Checkbox2SvgIcon from "./icons/PlasmicIcon__Checkbox2Svg"; // plasmic-import: xMZ1bSh4-Lfl/icon
import Checkbox1SvgIcon from "./icons/PlasmicIcon__Checkbox1Svg"; // plasmic-import: HOKDuEl8uqzf/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: mk8-3iTc0odg/icon
import Checkbox3SvgIcon from "./icons/PlasmicIcon__Checkbox3Svg"; // plasmic-import: L3UrmdEuprp6/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: AIMlFAb-m3wO/icon
          ...
          >
            ...
            >
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg__oqZda, {
                  [sty.svg___focusVisibleWithin__oqZdaA7X7G]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked__oqZda5A53I]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled__oqZdapOlzw]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate__oqZdatX2PB]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel__oqZdaFi7E0]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
              ...
              <PlasmicIcon__
                ...
                className={classNames(projectcss.all, sty.svg___0IaqX, {
                  [sty.svg___focusVisibleWithin___0IaqXa7X7G]:
                    triggers.focusVisibleWithin_root,
                  [sty.svgisChecked___0IaqX5A53I]: hasVariant(
                    $state,
                    "isChecked",
                    "isChecked"
                  ),
                  [sty.svgisDisabled___0IaqXpOlzw]: hasVariant(
                    $state,
                    "isDisabled",
                    "isDisabled"
                  ),
                  [sty.svgisIndeterminate___0IaqXtX2PB]: hasVariant(
                    $state,
                    "isIndeterminate",
                    "isIndeterminate"
                  ),
                  [sty.svgnoLabel___0IaqXFi7E0]: hasVariant(
                    $state,
                    "noLabel",
                    "noLabel"
                  )
            ...
            {(hasVariant($state, "noLabel", "noLabel") ? false : true) ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__cCztp)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
...
function useBehavior<P extends pp.CheckboxProps>(
  ...
  if (!("children" in props)) {
    props = {
      ...props,
      children: (
        <div className={classNames(projectcss.all, sty.freeBox__cCztp)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
