...
import { detailsEndometriome, endometriomeWrapper } from "../../endoComp";
                          ...
                          const child$Props = {
                            ...
                            imageValue: hasVariant(
                              ...
                              ? (() => {
                                  try {
                                    return (
                                      lesionsFolderImages + currentItem.image_en
                                    );
                                  } catch (e) {
                                    if (
                                      e instanceof TypeError ||
                              ...
                              : (() => {
                                  try {
                                    return (
                                      lesionsFolderImages + currentItem.image_fr
                                    );
                                  } catch (e) {
                                    if (
                                      e instanceof TypeError ||
                            ...
                            videoContent: hasVariant(
                              ...
                              ? (() => {
                                  try {
                                    return (
                                      lesionsFolderImages + currentItem.video_en
                                    );
                                  } catch (e) {
                                    if (
                                      e instanceof TypeError ||
                              ...
                              : (() => {
                                  try {
                                    return (
                                      lesionsFolderImages + currentItem.video_fr
                                    );
                                  } catch (e) {
                                    if (
                                      e instanceof TypeError ||
