...
import Label from "../../Label"; // plasmic-import: F19IkGHAIx--/component
import TextInput from "../../TextInput"; // plasmic-import: Qz1qcIox2Veo/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: eZCyg35GAlG6/component
import Description from "../../Description"; // plasmic-import: nvQa0CtcIh_P/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: leAY-h2Zv6Zr/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__idgaq, {
          [sty.freeBoxiconEnd__idgaqW52Vq]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__idgaqMgE5U]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__idgaqV6Eok]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__n6SC, {
            [sty.freeBoxiconStart__n6SCMgE5U]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__n6SCV6Eok]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zybrZ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hJHcX, {
            [sty.freeBoxiconEnd__hJHcXw52Vq]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hJHcXMgE5U]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oGXxg)}
                role={"img"}
              />
            ),
