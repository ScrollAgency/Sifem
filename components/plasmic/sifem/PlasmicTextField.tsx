...
import Label from "../../Label"; // plasmic-import: 4AXbtk7WtknF/component
import TextInput from "../../TextInput"; // plasmic-import: VdnsLb1yRHpi/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 9pTiWEysp4Qp/component
import Description from "../../Description"; // plasmic-import: e1YBHTonnn7u/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: xY17ROzAv-5m/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___3QfIr, {
          [sty.freeBoxiconEnd___3QfIRecyYn]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___3QfIrq7ZL9]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___3QfIrvvk1P]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__deMf, {
            [sty.freeBoxiconStart__deMfQ7ZL9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__deMfVvk1P]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___7JqRm)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hIeKl, {
            [sty.freeBoxiconEnd__hIeKLecyYn]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hIeKlq7ZL9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__x1X8G)}
                role={"img"}
              />
            ),
