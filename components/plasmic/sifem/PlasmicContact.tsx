...
import sty from "./PlasmicContact.module.css"; // plasmic-import: 9ZaIMqK2qT4Y/css
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__m6BKs,
                    {
                      [sty.textglobal_locale_en__m6BKsY6Rt2]: hasVariant(
                        globalVariants,
                        "locale",
                        "en"
                      )
                      ...
                      </React.Fragment>
                      {
                        <PlasmicLink__
                          className={classNames(
                            ...
                            sty.link__c2Lah,
                            {
                              [sty.linkglobal_locale_en__c2LahY6Rt2]:
                                hasVariant(globalVariants, "locale", "en")
                            }
                          )}
                          component={Link}
