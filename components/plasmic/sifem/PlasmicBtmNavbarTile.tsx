...
import sty from "./PlasmicBtmNavbarTile.module.css"; // plasmic-import: BsSasfqP5JtI/css
              ...
              defaultContents: (
                <React.Fragment>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___8PNxC)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__sRvb3)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__kqstd)}
                    />
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__lAtBn)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__tu9Dl)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__zgCxJ)}
                    />
                  </Stack__>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__v20An)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__mRu7)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__vjUNk)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox___3MrE)}
                    />
                  </Stack__>
                </React.Fragment>
              ),
