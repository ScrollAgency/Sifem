...
import sty from "./PlasmicBtmNavbarTile.module.css"; // plasmic-import: PVfZdYHy4jzc/css
              ...
              defaultContents: (
                <React.Fragment>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__t3Zm)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__lJkqv)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__aKEwH)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__oJtM5)}
                    />
                  </Stack__>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__dbcvh)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__wKvbn)}
                    />
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__kmhGz)}
                    />
                  </Stack__>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__ykKk)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__kZilL)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__wbvGu)}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__kCw3)}
                    />
                  </Stack__>
                </React.Fragment>
              ),
