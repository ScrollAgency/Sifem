...
import sty from "./PlasmicCheckboxWrapper.module.css"; // plasmic-import: ZhLOx1tCgnhw/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__bnjYr, {
                [sty.checkboxhasMedia__bnjYr8RtP]: hasVariant(
                  $state,
                  "hasMedia",
                  "hasMedia"
                )
