...
import sty from "./PlasmicCheckboxWrapper.module.css"; // plasmic-import: lpOLwhvXQQVF/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kgcnr, {
                [sty.checkboxhasMedia__kgcnrcKaTx]: hasVariant(
                  $state,
                  "hasMedia",
                  "hasMedia"
                )
