...
import MenuPopover from "../../MenuPopover"; // plasmic-import: tS8UkZICQ4tb/component
import MenuItem from "../../MenuItem"; // plasmic-import: 6xrDR60XpzMB/component
import MenuSection from "../../MenuSection"; // plasmic-import: D6o2o5Sj9HzR/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 2F_vr_rKhSdY/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__dv2Kf)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
