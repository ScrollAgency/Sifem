...
import MenuPopover from "../../MenuPopover"; // plasmic-import: nhLoTZmMB3fg/component
import MenuItem from "../../MenuItem"; // plasmic-import: pHB9PzNwG0pn/component
import MenuSection from "../../MenuSection"; // plasmic-import: 4aNqPLxgFCYB/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: h7nM1Ig8-AGN/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__rGvih)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
