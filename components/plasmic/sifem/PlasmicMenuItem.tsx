...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: pHB9PzNwG0pn/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fyNnu)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__jhjUa)}>
            <div
              className={classNames(
                projectcss.all,
