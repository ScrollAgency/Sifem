...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: _N1MFTtJo7Vd/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___96WWu)}>
        <div className={classNames(projectcss.all, sty.freeBox__aYuFk)} />
      </div>
      {renderPlasmicSlot({
