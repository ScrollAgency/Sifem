...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: BdTwaCvmccO9/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___7UojS)}>
        <div className={classNames(projectcss.all, sty.freeBox__xUndj)} />
      </div>
      {renderPlasmicSlot({
