...
import sty from "./PlasmicButton.module.css"; // plasmic-import: -BkoXfQ_mA7-/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: Yw1_HV9alQRc/icon
import PlusIcon from "./icons/PlasmicIcon__Plus"; // plasmic-import: Sl7mFqMAmm7m/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__nsqdL)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0VuN2)}
                role={"img"}
              />
            ),
