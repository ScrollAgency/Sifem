...
import sty from "./PlasmicButton.module.css"; // plasmic-import: DVuV3lh8L2we/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: umpGfCAaGpna/icon
import PlusIcon from "./icons/PlasmicIcon__Plus"; // plasmic-import: Und1G8nFhNc4/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__uzp8P)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ox2L)}
                role={"img"}
              />
            ),
