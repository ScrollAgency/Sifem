...
import { Select as AntdSelect } from "antd"; // Ajout pour le Select
                      ...
                      >
                        ...
                        {(_par =>
                          ...
                          (() => {
                            try {
                              return $state.submission.filter(
                                x => x.category_fr === "Annexielle 1 > côté droit"
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                        ...
                        {(() => {
                          try {
                            return (
                              $state.submission.filter(
                                x => x.category_fr === "Annexielle 2 > côté droit"
                              ).length == 0
                            );
                          } catch (e) {
                            if (
                        ...
                        {(_par =>
                          ...
                          (() => {
                            try {
                              return $state.submission.filter(
                                x =>
                                  x.category_fr === "Annexielle 3 > côté gauche"
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                        ...
                        {(() => {
                          try {
                            return (
                              $state.submission.filter(
                                x =>
                                  x.category_fr === "Annexielle 4 > côté gauche"
                              ).length == 0
                            );
                          } catch (e) {
                            if (
                            ...
                            return (
                              $state.submission.filter(
                                x =>
                                  ...
                                  x.category_fr !== "Annexielle 5 > côté droit"
                              ).length == 0
                            );
                          } catch (e) {
                            if (
                            ...
                            try {
                              return $state.submission.filter(
                                x =>
                                  ...
                                  x.category_fr !==
                                    "Annexielle > côté gauche" &&
                                  x.category_fr !== "Annexielle 6 > côté droit"
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                            ...
                            return (
                              $state.cat.filter(
                                x =>
                                  ...
                                  x.category_fr !==
                                    "Annexielle > côté gauche" &&
                                  x.category_fr !== "Annexielle 7 > côté droit"
                              ).length == 0
                            );
                          } catch (e) {
                            if (
                            ...
                            try {
                              return $state.cat.filter(
                                x =>
                                  ...
                                  x.category_fr !==
                                    "Annexielle > côté gauche" &&
                                  x.category_fr !== "Annexielle 8 > côté droit"
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
            ...
            >
              ...
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                (() => {
                  try {
                    return $state.submission.filter(
                      x => x.category_fr === "Annexielle 9 > côté droit"
                    );
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
              ...
              {(() => {
                try {
                  return (
                    $state.submission.filter(
                      x => x.category_fr === "Annexielle 10 > côté droit"
                    ).length == 0
                  );
                } catch (e) {
                  if (
            ...
            >
              ...
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                (() => {
                  try {
                    return $state.submission.filter(
                      x => x.category_fr === "Annexielle 11 > côté gauche"
                    );
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
              ...
              {(() => {
                try {
                  return (
                    $state.submission.filter(
                      x => x.category_fr === "Annexielle 12 > côté gauche"
                    ).length == 0
                  );
                } catch (e) {
                  if (
