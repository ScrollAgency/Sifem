...
import sty from "./PlasmicMenuItem2.module.css"; // plasmic-import: yWcgJkcChm8E/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rzdh3)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__oebRg)}>
            <div
              className={classNames(
                projectcss.all,
