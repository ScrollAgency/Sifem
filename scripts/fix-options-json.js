// Script de correction pour options.json
// Usage: node fix-options-json.js

const fs = require('fs');
const path = require('path');

const filePath = path.join(__dirname, '../public/options.json');
...
console.log('Correction terminée: options.json est conforme au SQL.');
